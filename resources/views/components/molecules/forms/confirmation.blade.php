...
<h2 class="mb-1 text-lg font-semibold text-dark-500 dark:text-dark-400">Are you sure?</h2>
<h3 class="mb-1 text-lg text-dark-500 dark:text-dark-400">You won't be able to revert this!</h3>
