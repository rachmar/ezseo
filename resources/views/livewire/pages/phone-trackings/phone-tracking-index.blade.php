        ...
        <div class="w-full mb-1">
            ...
            @if(count($phoneNumbers['data']) > 0)
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    <a href="{{ route('report-phone-trackings', ['company'=> $selectedCompany->id]) }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
